...
import 'package:foodpanda_app/utilities/extensions_function.dart';
...
class Utils {
  ...
  static bool verifyEmail(BuildContext context, String email) {
    if (email.isEmpty) {
      String errorMessage = 'Email is a required field.';
      Dialogs.showAlertDialog(context, 'Invalid Input', errorMessage);
      return false;
